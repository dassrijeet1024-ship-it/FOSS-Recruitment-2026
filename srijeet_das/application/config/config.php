...
|
*/
$config['encryption_key'] = md5('technobr');

$config['key'] = '8373197000523095';
$config['iv'] = '8080808080808080';
...
$config['sess_save_path'] = 'D:/INETPUB/VHOSTS/technobrains.net.in/tmp';
...
$config['csrf_token_name'] = 'cciict_test_name';
$config['csrf_cookie_name'] = 'cciict_cookie_name';
...
if(isset($sq_dbname))
{
	...
	$config['app_name']=$csetting['App_Name'];
	$config['app_title']=$csetting['App_Title'];
	...
	// default account id
	$config['default_aid']=$csetting['Default_account_id'];
	...
	$config['smtp_crypto'] = $csetting['SMTP_crypto'];
	...
	$config['admin_email'] = $csetting['Admin_email'];
	$config['admin_name']  = $csetting['Admin_name'];
	...
	$config['fromname']=$csetting['App_Name'];
	
	$config['no_reply_email']=$csetting['No_reply_email'];

	$config['master_password']=$csetting['Master_password'];
	
	$config['logout_timer']=intval($csetting['Logout_timer']) * 60;
...
$config['allowed_types'] = 'gif|jpg|png|pdf|doc|xls|docx|xlsx|ppt|pptx|mp4|ogg|htm|html';
$config['file_types'] = '.gif, .jpg, .png, .pdf, .doc, .xls, .ppt, .mp4, .html, .htm';
$config['mime_types'] = array('image/gif','image/jpeg','image/pjpeg','image/png','image/x-png','application/pdf','application/msword','application/vnd.ms-excel','application/powerpoint','video/mp4','text/html','text/htm');
$config['max_size'] = 2097152;
$config['max_image_width'] = 400;

$config['upload_max_filesize'] = '256M';
$config['post_max_size'] = '256M';
$config['max_input_time'] = '3000';
$config['max_execution_time'] = '3000';
