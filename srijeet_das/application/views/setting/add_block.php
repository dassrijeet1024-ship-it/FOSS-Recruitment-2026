		...
		<div class="col-md-6">
			<div class="card shadow shadow-sm">
				...
				<div class="card-body">
					...
					?>
					<?=form_open('settings/insert_block',array('id'=>'myForm','class'=>'needs-validation','novalidate' => 'novalidate'))?>
						...
						<div class="form-group">
							...
							<input type="text" required name="block" class="form-control" placeholder="<?= $this->lang->line('block') ?>" autocomplete="off" /> 
						</div>
						<div class="form-group">	
