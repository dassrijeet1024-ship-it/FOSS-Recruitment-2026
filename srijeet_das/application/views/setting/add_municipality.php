		...
		<div class="col-md-6">
			<div class="card shadow shadow-sm">
				...
				<div class="card-body">
					...
					?>
					<?=form_open('settings/insert_municipality',array('id'=>'myForm','class'=>'needs-validation','novalidate' => 'novalidate'))?>
						...
						<div class="form-group">
							...
							<input type="text" required name="municipality" class="form-control" placeholder="<?= $this->lang->line('municipality') ?>" autocomplete="off" /> 
						</div>
						<div class="form-group">
							<label for="code"><?php echo $this->lang->line('website_url');?></label> 
							<input type="text" name="website_url" class="form-control" placeholder="<?= $this->lang->line('url') ?>" autocomplete="off" /> 
						</div>
						<div class="form-group">
							<label for="code"><?php echo $this->lang->line('property_payment_url');?></label> 
							<input type="text" name="property_payment_url" class="form-control" placeholder="<?= $this->lang->line('url') ?>" autocomplete="off" /> 
						</div>
						<div class="form-group">
							<label for="code"><?php echo $this->lang->line('water_payment_url');?></label> 
							<input type="text" name="water_payment_url" class="form-control" placeholder="<?= $this->lang->line('url') ?>" autocomplete="off" /> 
						</div>
						<div class="form-group">
							<label for="code"><?php echo $this->lang->line('grabage_payment_url');?></label> 
							<input type="text" name="grabage_payment_url" class="form-control" placeholder="<?= $this->lang->line('url') ?>" autocomplete="off" /> 
						</div>
						<div class="form-group">	
