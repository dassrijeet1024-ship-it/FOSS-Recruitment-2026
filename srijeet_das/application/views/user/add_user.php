		...
		<div class="col-md-6">
			<div class="card shadow shadow-sm">
				...
				<div class="card-body">
					...
					?>
					<?=form_open('user/insert_user',array('enctype'=>'multipart/form-data','id'=>'myForm','class'=>'needs-validation','novalidate'=>'novalidate'))?>
						...
						<div class="form-group">
							...
							<select name="su" id="su" required class="form-select select-arrow textbox">
								...
								<option value="<?php echo $account['aid'];?>"><?php echo $account['account'];?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
							...
							<select name="user_status" required class="form-select select-arrow textbox">
								<option value="" hidden><?php echo $this->lang->line('select');?></option>
								<option value="<?=$this->lang->line('active')?>" <?php if (set_value('user_status')==$this->lang->line('active')) echo "selected"; ?> /><?php echo $this->lang->line('active');?></option>
								<option value="<?=$this->lang->line('inactive')?>" <?php if (set_value('user_status')==$this->lang->line('inactive')) echo "selected"; ?> /><?php echo $this->lang->line('inactive');?></option>
								<option value="<?=$this->lang->line('archive')?>" <?php if (set_value('user_status')==$this->lang->line('archive')) echo "selected"; ?> /><?php echo $this->lang->line('archive');?></option>
							</select>
						</div>
